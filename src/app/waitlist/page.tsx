...
const socials = [
  { label: "@kattegat.app", href: "https://instagram.com/kattegat.app" },
  { label: "@kattegat.vetted", href: "https://instagram.com/kattegat.vetted" },
  { label: "@kayzar.floki", href: "https://instagram.com/kayzar.floki" },
  { label: "@verou.poli", href: "https://instagram.com/verou.poli" },
];
    ...
    <main className="min-h-screen overflow-hidden text-brand-forest">
      <section className="px-3 py-3 sm:px-6 sm:py-6">
        <div className="launch-stage relative mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-7xl flex-col overflow-hidden rounded-[2rem] border border-white/80 px-5 py-6 shadow-2xl shadow-brand-forest/8 backdrop-blur-2xl sm:min-h-[calc(100vh-3rem)] sm:rounded-[3rem] sm:px-8 lg:px-14">
          <div className="animate-drift pointer-events-none absolute left-1/2 top-[14%] h-[38rem] w-[38rem] -translate-x-1/2 rounded-full border border-dashed border-brand-forest/8" />
          <div className="animate-drift-reverse pointer-events-none absolute left-1/2 top-[26%] h-[23rem] w-[23rem] -translate-x-1/2 rounded-full border border-dashed border-brand-forest/8" />
          <Sparkles className="animate-drift pointer-events-none absolute bottom-[12%] left-1/2 h-4 w-4 -translate-x-1/2 text-brand-forest/18" />
          <Sparkles className="animate-drift-reverse pointer-events-none absolute left-[12%] top-[63%] h-4 w-4 text-brand-forest/18" />
          <Sparkles className="animate-drift pointer-events-none absolute right-[12%] top-[63%] h-4 w-4 text-brand-forest/18" />
          ...
          <header className="animate-in fade-in slide-in-from-top-4 relative z-10 flex items-center justify-between gap-4 duration-700">
            <Link href="/waitlist" className="flex min-w-0 items-center">
              <Image
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col items-center justify-center py-12 text-center sm:py-16">
            ...
            <p className="animate-in fade-in slide-in-from-bottom-4 mx-auto mt-7 max-w-2xl text-base font-medium leading-8 text-muted-foreground delay-150 duration-700 sm:text-xl">
              The app for Dubai&apos;s events & hospitality industry. Talent talks to clients directly —{" "}
              <strong className="text-brand-forest">no commission, no management fee. Keep all your money.</strong>
            </p>
            ...
            <div id="join" className="animate-in fade-in slide-in-from-bottom-6 mt-10 w-full scroll-mt-8 delay-500 duration-700">
              <div className="mb-4 flex items-center justify-center gap-3">
                <AvatarGroup>
                  ...
                  <AvatarGroupCount className="bg-white text-xs font-extrabold text-brand-forest">+1K</AvatarGroupCount>
                </AvatarGroup>
      ...
      <section id="milestones" className="mx-auto w-full max-w-6xl px-5 py-12 sm:px-8">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            A clean build path from early access to public launch, with the first seller seats handled before the doors open.
          </p>
        </Reveal>
        ...
        <div className="relative mt-12">
          ...
          <ol className="relative grid gap-6 lg:grid-cols-5 lg:gap-5">
            {milestones.map((item, index) => {
              ...
              return (
                <Reveal key={item.title} as="li" delayMs={index * 120} className="relative grid grid-cols-[3.25rem_1fr] gap-4 lg:grid-cols-1">
                  ...
                  >
                    <CardContent className="p-5 lg:min-h-48">
                      ...
                      <h3 className="mt-2 text-base font-extrabold leading-6 text-brand-forest">{item.title}</h3>
            ...
            <Reveal key={episode.title} delayMs={index * 100}>
              <Card className="glass-panel h-full rounded-[1.75rem] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-forest/10">
                <CardContent className="p-6">
                  ...
                  <h3 className="mt-3 text-lg font-bold leading-7 text-brand-forest">{episode.title}</h3>
          ...
          <Reveal delayMs={150}>
            <Card className="glass-panel rounded-[2rem] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-forest/10">
              <CardContent className="p-6 text-base leading-8 text-muted-foreground sm:p-8 sm:text-lg">
                ...
                <p className="mt-4">
                  <strong className="text-brand-forest">So we built the room where the two sides meet directly.</strong>{" "}
