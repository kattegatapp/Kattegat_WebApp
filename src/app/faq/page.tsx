...
export const metadata: Metadata = {
  title: "FAQ | Kattegat",
  description: "Answers to common questions about Kattegat for buyers and sellers.",
};
...
const questions = [
  ...
  { q: "Who can use Kattegat?", a: "Businesses can find specialist sellers. Service professionals and companies can present their capabilities and respond to relevant demand." },
  { q: "Does Kattegat take commission from bookings?", a: "Kattegat is designed around zero booking commission. Sellers keep the agreed value of their work." },
  { q: "How do businesses find sellers?", a: "Businesses can explore service categories, review profiles and trust signals, publish requirements, and speak directly with suitable sellers." },
  { q: "How do sellers join?", a: "Sellers create an account, complete their service profile, add relevant capabilities, and respond to marketplace opportunities when access is available." },
...
export default function FaqPage() {
  return (
    <MarketingPageShell eyebrow="Frequently asked questions" title="The useful answers, all in one place." description="Learn how the marketplace works for businesses and sellers, how direct booking operates, and what kinds of services belong on Kattegat.">
