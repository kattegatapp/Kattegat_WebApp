...
export const metadata: Metadata = { title: "How It Works | Kattegat", description: "Learn how businesses and service providers discover, connect, and work together on Kattegat." };

export default function HowItWorksPage() {
  const steps = [{ icon: Search, title: "Explore or publish a brief", body: "Businesses browse specialists or describe exactly what they need. Providers build structured service profiles that are easy to compare." }, { icon: UserRoundCheck, title: "Review the right fit", body: "Assess capabilities, experience, service detail, and marketplace trust signals before starting a conversation." }, { icon: MessageCircle, title: "Talk directly", body: "Share context, ask questions, and align on scope with the person or team delivering the work." }, { icon: BadgeCheck, title: "Confirm and collaborate", body: "Move forward confidently with a clear conversation trail and no commission taken from the booking." }];
  return <MarketingPageShell eyebrow="How Kattegat works" title="A shorter route from need to know-how." description="Kattegat gives businesses and specialist providers a direct, structured way to find each other and move from first search to working relationship.">
